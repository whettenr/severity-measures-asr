...
if sys.argv[1] == 'base':
    ...
    weights_dir = "/home/slimlab/ryan/severity-measures-asr/base_model_weights/"
    ...
    weights_dir = "/home/slimlab/ryan/severity-measures-asr/cos_ctc_model_weights/"
...
def rerun_performance(model, epochs, name='model', weights_dir=weights_dir):
    rerun_hist = {
    ...
    for epoch in tqdm(range(epochs)):
        print("\nStart of epoch %d" % (epoch,) + '\nwith ' + weights_dir + name + '_weights_' + str(epoch))    
...
hist_data = rerun_performance(model, 50, 'model_' + sys.argv[1])

# with open('rerun_history_'+ sys.argv[1] +'.pkl', 'wb') as handle:
